...
AlsultanSysSize()
{
	du -sh /data/data/alsultan.shell/rootfs 2>/dev/null | cut -d'/' -f1 | xargs 2>/dev/null || echo "0"
...
printf "${CYAN}│%-15s " ; printf "${BYELLOW}%-30s${CYAN}│\n" " "
printf  "│              ${BRED}Created By AL-SULTAN${RST}${CYAN}            │\n"
printf  "│            ${BRED}Mohammad Gamal Al-Quaiti${RST}${CYAN}          │\n"
printf  "│             ${BRED}ALSULTAN.IT@OUTLOOK.COM${RST}${CYAN}          │\n"
printf  "│               ${BRED}+966 5 370 570 80${RST}${CYAN}              │\n"
printf  "└──────────────────────────────────────────────┘${RST}\n"
